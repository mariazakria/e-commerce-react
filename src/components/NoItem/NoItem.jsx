...
export default function NoItem({ children }) {
    return (
        <div className="h-[60vh] text-center flex justify-center items-center flex-col">
            <div className="h-[60vh] text-center flex justify-center items-center flex-col">
                <div className="grid gap-4 ">
                    <svg className="mx-auto" xmlns="http://www.w3.org/2000/svg" width={154} height={161} viewBox="0 0 154 161" fill="none">
                        ...
                        <rect x="38.3522" y="21.5128" width="41.0256" height="2.73504" rx="1.36752" fill="#FF6B6C" />
                        <rect x="38.3522" y="133.65" width="54.7009" height="5.47009" rx="2.73504" fill="#FF6B6C" />
                        <rect x="38.3522" y="29.7179" width="13.6752" height="2.73504" rx="1.36752" fill="#FF6B6C" />
                    ...
                    <div>
                        <h2 className="text-center text-black text-xl font-semibold leading-loose pb-2">{children[0]}</h2>
                        <p className="text-center text-black text-base font-normal leading-relaxed pb-4">{children[1]} </p>

                    </div>
                </div>
                <Link to={"/AllProducts"} className="btn mt-4">
                    Back to Products
                </Link>
            </div>
        </div>
