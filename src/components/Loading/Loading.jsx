...
export default function Loading() {
  return (
   <>
 <div className={`h-screen flex justify-center items-center ${style.preloader}`}>
    ...
    <g fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth={8}>
      ...
      <g className={style.cart__lines} stroke="currentColor">
        ...
        <g className={style.cart__wheel1} transform="rotate(-90,43,111)">
          <circle className={style.cart__wheel_stroke} cx={43} cy={111} r={13} strokeDasharray="81.68 81.68" strokeDashoffset="81.68" />
        </g>
        <g className={style.cart__wheel2} transform="rotate(90,102,111)">
          <circle className={style.cart__wheel_stroke} cx={102} cy={111} r={13} strokeDasharray="81.68 81.68" strokeDashoffset="81.68" />
        </g>
      </g>
    </g>
  </svg>
